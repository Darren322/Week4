...
function show(button_element) {
    ...
    */
    ...
    let funFact = document.getElementById("ta-fun-fact");
    let photo = document.getElementById("ta-photo");
        ...
        funFact.innerHTML = facts[button_element.id];
        photo.outerHTML = "<img id='ta-photo' src='photos/" + button_element.id  + ".jpg'>";
        })
